...
def win_battle():
    ...
    if dungeon_active:
        ...
        # ----------------------------------------------------
        # OS 3 MONSTROS DO GRUPO FORAM DERROTADOS
        # ----------------------------------------------------
            ...
            # Desbloqueia próxima ilha
            if (
                current_island + 1
                > player.unlocked_islands
            ):
            ...
            # Registra masmorra como concluída
            ...
            # IMPORTANTE
            #
            # NÃO SAÍMOS DA MASMORRA.
            #
            # Começa outro grupo de 3 monstros.
            # =================================================
            ...
            show_message(
                ...
                f"+{reward_xp} XP. "
                f"Prepare-se para o próximo grupo!"
            )
...
def enter_dungeon():
    ...
    show_message(
        ...
        "Não existe saída. "
        "Você só poderá sair quando morrer.",
        4
    )
...
def start_dungeon_battle():
    ...
    # O nível dos monstros aumenta conforme
    # os grupos vão avançando.
    ...
    # A cada 3 monstros, aumenta a dificuldade
    monster_level += min(
        2,
        dungeon_round // 3
    )
